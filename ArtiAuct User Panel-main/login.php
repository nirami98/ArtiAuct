...
<!-- Mirrored from demo.enpek.com/html-templates/dye/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Sep 2018 12:24:54 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 heading-title">
                        <h2 class="text-capitalize margin-clear text-center"><span>Login</span></h2>
                    </div>
                    <div class="col-md-6 col-xs-12 col-sm-6 margin-top-30">
                        <div class="form-contact">
                            <div class="row">
                                <form accept-charset="UTF-8" action="checklogin.php" class="contact-form" method="POST">
                                    <div class="col-md-12 col-xs-12 col-sm-12">
                                        <input name="form_type" type="hidden" value="contact">
                                        <input name="utf8" type="hidden" value="✓">
                                        <div class="input-group margin-bottom-20">
                                            <span class="input-group-addon" id="basic-addon13">Email</span>
                                            <input type="text" placeholder="Email or Username"  class="form-control" aria-describedby="basic-addon3" name="email" value="<?php echo $email; ?>">
                                            
                                        </div>
                                        <div class="input-group margin-bottom-20">
                                            <span class="input-group-addon" id="basic-addon14">Password</span>
                                            <input type="password" placeholder="Password" class="form-control" aria-describedby="basic-addon3" name="password" value="<?php echo $password; ?>">

                                        </div>

                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="keepme"> Keep me logged in
                                            </label>
                                        </div>                                        

                                        <div class="for-pass full-width">
                                            <input type="submit" class="btn btn-lg btn-success margin-top-15" name="signin_btn" value="Sign In">
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="col-md-6 col-xs-12 col-sm-6 margin-top-30">
                        <div class="creat-account">
                            ...
                            <a href="register.php" class="btn btn-lg btn-success margin-top-15">Create An Account</a>
                        </div>
                    </div>
                </div>
            </div>
