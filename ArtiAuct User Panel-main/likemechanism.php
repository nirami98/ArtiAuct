...
?>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="margin-top-15 text-left">
                               ...
                               <?php 
                                    $c = $row['id'];
                                    $q = "SELECT count(*) from likestbl where postid = $c";
                                    $r = mysqli_query($conn, $q);
                                    $row1=mysqli_fetch_assoc($r);
                                    $countno = $row1['count(*)'];
                               ?>

                                <a href="addlike.php?pid=<?php echo $row['id']; ?>" type="submit_like" name="like" class="float-right btn text-white btn-danger" value="Send"><i class="fa fa-heart"></i> &nbsp <?php echo $countno; ?> Likes</a>
                            </div>
                                <br><br><br><br>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12 paira-margin-top-1">
                        <form class="popup-search-form" method="post" action="search.php">
                            <input type="text" class="form-control padding-clear pop-light" name="searchtext" value="" placeholder="Search Here..."/>
                            <button class="search"><i class="fa fa-search fa-2x"></i></button>
                            <button class="btn btn-success btn-lg text-uppercase pull-right margin-top-15" name="sb">go</button>
                        </form>
                    </div>
                </div>
            </div>
