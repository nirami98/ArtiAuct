                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 margin-bottom-30 heading-title">
                            <h2 class="text-capitalize margin-clear text-center"><span>Complain here</span></h2>
                        </div>
                        <div class="form-contact">
                            <div class="row">
                                <div class="col-md-12 col-xs-12 col-sm-12">
                                    <form accept-charset="UTF-8" action="insertcomplain.php" class="contact-form" method="post">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="input-group margin-bottom-20">
                                                <span class="input-group-addon" id="basic-addon11">Complain Message</span>
                                                <textarea rows="10" name="message" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <button type="submit" name="submit" class="btn btn-success btn-lg text-capitalize" value="Send">Send</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
