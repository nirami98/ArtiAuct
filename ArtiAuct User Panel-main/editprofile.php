...
<head>
    ...
    <title>ArtiAuct - Edit Profile</title>
    <!--=================== Bootstrap core CSS ===================-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 heading-title">
                        <h2 class="text-capitalize margin-clear text-center"><span>Edit Profile</span></h2>
                    </div>
                            ...
                            <div class="row">
                                <form accept-charset="UTF-8" class="contact-form" method="POST" action="insertion.php" enctype="multipart/form-data">
                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="input-group margin-bottom-20">
                                            <span class="input-group-addon" id="basic-addon15">Update Profile Picture</span>
                                        ...
                                        <div class="for-pass full-width">
                                            <input type="submit" name="submit" value="Update Profile" class="btn btn-lg btn-success margin-top-15">
                                        </div>
                                    </div>
                                </form>
                            </div>
