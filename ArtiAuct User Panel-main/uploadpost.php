<?php 
    ...
    if($uploadok_i ==1)
    {
        $qry = "INSERT INTO post_tbl(catid, postname, posthash1, posthash2, posthash3, posthash4, postdescription, postpicture, isproduct, isactive, doi, dou) VALUES ($cat_id, '".$name."', '".$h1."', '".$h2."', '".$h3."', '".$h4."', '".$description."', '".$picture."', $ip, $isactive, NOW(), NOW())";
