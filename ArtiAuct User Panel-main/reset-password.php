...
<head>
    ...
    <title>ArtiAuct - Reset Password</title>
    <!--=================== Bootstrap core CSS ===================-->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="col-md-6 col-xs-12 col-sm-6 margin-top-30">
                            <div class="form-contact">
                                <div class="row">
                                    <form accept-charset="UTF-8" action="resetpasswordprocess.php" class="contact-form" method="post">
                                        <div class="col-xs-12 col-md-12 col-sm-12">
                                            <input name="form_type" type="hidden" value="contact">
                                            <input name="utf8" type="hidden" value="✓">
                                            <div class="input-group margin-bottom-20">
                                                <span class="input-group-addon" id="basic-addon13">New Password</span>
                                                <input type="password" name="newp" class="form-control" aria-describedby="basic-addon3">
                                            </div>
                                            <div class="for-pass full-width">

                                                <input type="submit" name="submit" value="Reset Password" class="btn btn-lg btn-success margin-top-15">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6 margin-top-30 cols">
                            <div class="creat-account">
                                ...
                                <a href="home2.php" class="btn btn-lg btn-success margin-top-15">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
