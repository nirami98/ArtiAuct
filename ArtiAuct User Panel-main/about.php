                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="about-description">
                            <p class="margin-top-30">ArtiAuct provides a platform for artists who are in search of a platform to persue their talent.</p>
                            <p class="margin-top-10 margin-bottom-15">This is the platform where one can explore the best of art pieces within one website. Our admins provides daily challenges to the atrists which will help them to lift up their artistic skills by performing them. It is not mandatory to accept and perform the challenge. One can view the challenge and can upload the acceptance of it if he/she has already performed it int the past.
                            </p>
                            
                             <p class="margin-top-10 margin-bottom-15"><b>Our Admins:</b></p>

                            <ul class="list-unstyled margin-bottom-0 lists">
                                <li><b>>></b>Nirja Desai</li>
                                <li><b>>></b>Khushali Panchal</li>
                                <li><b>>></b>Shreya Joshi</li>
                                <li><b>>></b>Payal Devalia</li>
                            </ul>
                        </div>
                    </div>
                </div>
