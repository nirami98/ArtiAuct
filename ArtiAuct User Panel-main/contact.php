                    ...
                    <div class="col-md-12 margin-top-30">
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-6 margin-top-30">
                            <div class="text-center official-detail">
                                ...
                                <p>Government Polytechnic for Girls,
                                Opposite Physical Research Laboratory, Ahmedabad - 380 015</p>
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-12 col-sm-6 margin-top-30">
                            <div class="text-center official-detail">
                                <i class="fa fa-phone fa-3x"></i>
                                <p>Nirja Desai-9429120045<br>Khushali Panchal-7990485947<br>Shreya Joshi-8780366985<br>Payal Devalia-7016083997</p>
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-12 col-sm-6 margin-top-30">
                            <div class="text-center official-detail">
                                <i class="fa fa-envelope fa-3x"></i>
                                <p>nirjadesai9800@gmail.com<br>panchalkhushali1109@gmail.com<br>shreyajoshi2727@gmail.com<br>payaldevalia1111@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
