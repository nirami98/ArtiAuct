<!DOCTYPE html>
 ...
 <head>
    ...
    <title>ArtiAuct - Privacy Policy</title>
    <!--=================== Bootstrap core CSS ===================-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 heading-title text-center">
                        <h2 class="text-capitalize margin-clear"><span>Privacy Policy</span></h2>
                    </div>
                </div>
            </div>
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="about-description">
                            ...
                            <ul class="list-unstyled margin-bottom-0 lists">
                                <li><b>>></b> Remembering Your login status so that You don’t have to login again if You are already logged in.</li><br>
                                <li><b>>></b> Remember information so You will not have to re-enter it during Your visit or the next time You visit the Service.</li><br>
                                <li><b>>></b> We may use Your Personal Information for processing Your registration for Our Services. This may include verification of user information through mobile verification.</li><br>
                                <li><b>>></b> Automatically update the Application on Your device.</li><br>
                                <li><b>>></b> The administration of the site reserves the right to terminate any account without notice.</li><br>
                                <li><b>>></b> Help You efficiently access Your information after You sign in.</li><br>
                                <li><b>>></b> Communications between You and ArtiAuct. For example, We may send You Service-related emails (e.g., changes/updates to features of the Service, technical and security notices). Note that You may not opt out of Service-related e-mails.​</li><br>
                                <li><b>>></b> Monitor metrics such as total number of visitors, traffic, and demographic patterns​.</li><br>
                            </ul>
                        </div>
                    </div>
                </div>
