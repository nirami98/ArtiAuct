...
<!-- Mirrored from demo.enpek.com/html-templates/dye/search.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Sep 2018 12:25:11 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>ArtiAuct - Search Results</title>
    <!--=================== Bootstrap core CSS ===================-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 heading-title">
                        <h2 class="text-capitalize margin-clear text-center"><span>Search Result</span></h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="paira-widget paira-menu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="ppolicy.php">Privacy Policy</a></li>
