...
<head>
    ...
    <title>ArtiAuct - Terms and Conditions</title>
    <!--=================== Bootstrap core CSS ===================-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 heading-title text-center">
                        <h2 class="text-capitalize margin-clear"><span>Terms & Conditions</span></h2>
                    </div>
                </div>
            </div>
            <br>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="about-description">
                            <p class="margin-top-30"><b>-> This website is built on the purpose of ANTI-DUPLICACY. It works on the following terms and conditions:</b></p>
                            <p class="margin-top-10 margin-bottom-15"></p>
                            <ul class="list-unstyled margin-bottom-0 lists">
                                <li><b>>></b> In order to access some features of the Website, you will have to create a Wattpad.com account. You may never use another's account without permission. When creating your account, you must provide accurate and complete information. You are solely responsible for the activity that occurs on your account, and you must keep your account password secure. You must notify ArtiAuct.com immediately of any breach of security or unauthorized use of your account.</li><br>
                                <li><b>>></b> Although ArtiAuct.com will not be liable for your losses caused by any unauthorized use of your account, you may be liable for the losses of ArtiAuct.com or others due to such unauthorized use.</li><br>
                                <li><b>>></b> You will not create an account if you are under 13 years of age.</li><br>
                                <li><b>>></b> You are encouraged to create no more than one account. Using multiple accounts for any malicious activity will result in immediate account termination.</li><br>
                                <li><b>>></b> The administration of the site reserves the right to terminate any account without notice.</li><br>
                                <li><b>>></b> Plagiarism is  not allowed.</li><br>
                                <li><b>>></b> It is compulsory to put at least ONE hashtags on a post.</li><br>
                                <li><b>>></b> While accepting a challenge, only one hashtag is allowed.</li><br>
                                <li><b>>></b> User will be locked if reported plagiarism.</li><br>
