...
<head>
  ...
  <title>ArtiAuct | Category Management</title>
        ...
        <section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none" style="color: white">Category</h3>
                <small style="color: white">Add Categories</small>
              </div>
              
             <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="addcategoryprocess.php" method="GET">
                                      <div class="form-group">
                                        <label for="exampleInputEmail1" style="color: white; font-size: 18px">Category Name:</label>
                                        <input type="text" class="form-control" name="categoryname" id="exampleInputEmail1" placeholder="Category Name">
                                      </div>

                                      <button type="submit" class="btn btn-s-md btn-dark btn-rounded">Add</button>
                                    </form>
