...
<head>
  ...
  <title>ArtiAuct | Challenge Management</title>
        ...
        <section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none" style="color: white">Challenge</h3>
                <small style="color: white">Upload A Challenge</small>
              </div>
              
             <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="uploadchallengeprocess.php" method="GET">
  
                                      <div class="form-group">
                                        <label for="exampleInputEmail1" style="color: white; font-size: 18px">Challenge Name:</label>
                                        <input type="text" class="form-control" name="challengename" id="exampleInputEmail1" placeholder="Challenge Name">
                                      </div>
                                      <div class="form-group">
                                        <label for="exampleInputEmail1" style="color: white; font-size: 18px">Challenge Criteria:</label>
                                        <input type="text" name="challengecriteria" class="form-control" id="exampleInputEmail1" placeholder="Challenge Criteria">
                                      </div>
                                      <div class="form-group">
                                        <label for="exampleInputEmail1" style="color: white; font-size: 18px">Hashtag</label>
                                        <input type="text" name="hashtag" class="form-control" id="exampleInputEmail1" placeholder="Hashtag">
                                      </div>  
                                      <button type="submit" class="btn btn-s-md btn-dark btn-rounded">Upload</button>
                                    </form>
