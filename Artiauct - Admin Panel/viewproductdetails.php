...
<head>
  ...
  <title>ArtiAuct | Product Management</title>
        ...
        <section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none" style="color: white">Product</h3>
                <small style="color: white">View Products</small>
              </div>
              
              <?php 
                require 'dbconnect.php';
                $qry = "SELECT * FROM product_tbl WHERE isactive=1 OR isactive=0";
                                        ...
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><a href="statuschangeproduct.php?id=<?php echo $row['id']; ?>">Remove</a></td>
                                                </tr>
