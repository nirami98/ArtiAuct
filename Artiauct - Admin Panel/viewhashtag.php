        ...
        <section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none" style="color: white">HashTag</h3>
                <small style="color: white">View Hashtags</small>
              </div>
              
              <?php 
                require 'dbconnect.php';
                $qry = "SELECT * FROM hashtag_tbl";
                                        ...
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['hashtagname']; ?></td>
                                                    <td><?php echo $row['isactive']; ?></td>
                                                    <td><a href="statuschangehashtag.php?id=<?php echo $row['id']; ?>">Remove</a></td>
                                                </tr>
