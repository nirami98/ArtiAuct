...
<head>
  ...
  <title>ArtiAuct | State Management</title>
        ...
        <section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none" style="color: white">State</h3>
                <small style="color: white">Add States</small>
              </div>
              
             <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="addstateprocess.php" method="GET">
                                      <div class="form-group">
                                        <label for="exampleInputEmail1" style="color: white; font-size: 18px">State Name:</label>
                                        <input type="text" class="form-control" name="statename" id="exampleInputEmail1" placeholder="State Name">
                                      </div>
