...
<head>
  ...
  <title>ArtiAuct | Complain Management</title>
          ...
          <section id="content">
            <section class="vbox">          
              <section class="scrollable padder">
                ...
                <div class="m-b-md">
                  <h3 class="m-b-none" style="color: white">Complain</h3>
                  <small style="color: white">View & Manage Complains</small>
                </div>
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                  ...
                                  ?>
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $row['complainmessage'] ?></td>
