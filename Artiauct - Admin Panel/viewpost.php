...
<head>
  ...
  <title>ArtiAuct | Post Management</title>
        ...
        <section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none" style="color: white">Post</h3>
                <small style="color: white">View Posts</small>
              </div>
              
              <?php 
                require 'dbconnect.php';
                $qry = "SELECT * FROM post_tbl";
                                        ...
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['posthash1']; ?></td>
                                                    <td><?php echo $row['posthash2']; ?></td>
                                                    <td><?php echo $row['posthash3']; ?></td>
                                                    <td><?php echo $row['posthash4']; ?></td>
                                                    <td><?php echo $row['postdescription']; ?></td>
                                                    <td><?php echo $row['postpicture']; ?></td>
                                                    
                                                    <td><?php echo $row['isproduct']; ?></td>
                                                    <td><a href="removeproduct.php?id=<?php echo $row['id']; ?>">Remove</a></td>
                                                    <td><?php echo $row['isactive']; ?></td>
                                                    <td><a href="statuschangepost.php?id=<?php echo $row['id']; ?>">Remove</a></td>
                                                </tr>
