...
<head>
  ...
  <title>ArtiAuct | Comments Management</title>
        ...
        <section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none" style="color: white">Comments</h3>
                <small style="color: white">View Comments</small>
              </div>
              
              <?php 
                require 'dbconnect.php';
                $qry = "SELECT * FROM comments_tbl";
