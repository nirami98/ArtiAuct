          ...
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                ...
                <small style="color: white">View Challenge</small>
              </div>
              
              <?php 
                require 'dbconnect.php';
                $qry = "SELECT * FROM challenge_tbl";
                                            ...
                                            <tbody>
                                              ...
                                              ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['challengename']; ?></td>
                                                    <td><?php echo $row['challengecriteria']; ?></td>
                                                    <td><?php echo $row['hashtag']; ?></td>
                                                    <td><?php echo $row['isactive']; ?></td>
                                                    <td><a href="statuschangechallenge.php?id=<?php echo $row['id']; ?>">Remove</a></td>
                                                </tr>
