...
<head>
  ...
  <title>ArtiAuct | Inquiry Management</title>
                    ...
                    <li >
                      ...
                      <li>
                        <a href="#layout">
                          ...
                          <span class="pull-right">
                            <i class="fa fa-angle-down text"></i>
                            <i class="fa fa-question-circle text-active" ></i>
                          </span>
          ...
          <section id="content">
            <section class="vbox">          
              <section class="scrollable padder">
                ...
                <div class="m-b-md">
                  <h3 class="m-b-none" style="color: white">Inquiry</h3>
                  <small style="color: white">View Inquiries</small>
                </div>
                ...
                <?php 
                  ...
                  $qry = "SELECT * FROM inquiry_tbl WHERE isactive=1 OR isactive=0";
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                  ...
                                  ?>
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $row['inquirymessage'] ?></td>
