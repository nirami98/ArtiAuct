...
section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none">Challenge</h3>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Challenge ID</label>
    <input type="cid" class="form-control" id="exampleInputEmail1" placeholder="Challenge_ID">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Default Hash ID</label>
    <input type="cname" class="form-control" id="exampleInputEmail1" placeholder="Default_ID">
  </div>
  <!--<div class="form-group">
    <label for="exampleInputEmail1">Challenge Criteria</label>
    <input type="ccrt" class="form-control" id="exampleInputEmail1" placeholder="Challenge_Criteria">
  </div> -->
  <div class="form-group">
    <label for="exampleInputEmail1">Hash ID to be Executed</label>
    <input type="hid" class="form-control" id="exampleInputEmail1" placeholder="Executed_ID">
  </div>
<!--   <div class="form-group">
