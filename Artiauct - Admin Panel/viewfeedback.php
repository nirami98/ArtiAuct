...
<head>
  ...
  <title>ArtiAuct | Feedback Management</title>
          ...
          <section id="content">
            <section class="vbox">          
              <section class="scrollable padder">
                ...
                <div class="m-b-md">
                  <h3 class="m-b-none" style="color: white">Feedback</h3>
                  <small style="color: white">View Feedbacks</small>
                </div>
                <?php 
                  require 'dbconnect.php';
                  $qry = "SELECT * FROM feedback_tbl WHERE isactive=1 OR isactive=0";
