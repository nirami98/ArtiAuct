          ...
          <section class="vbox">
            <section class="w-f scrollable">
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                ...
                <!--<li>
                      <a href="addpro.php" class="active">
          ...
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                ...
                <small style="color: white">Add City</small>
              </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="addcityprocess.php" method="GET">
                                      ...
                                      <div class="form-group">
                                        <label for="exampleInputEmail1" style="color: white; font-size: 18px">City Name:</label>
                                        <input type="text" class="form-control" name="cityname" id="exampleInputEmail1" placeholder="City Name">
                                      </div>
