...
<head>
  ...
  <title>ArtiAuct | User Management</title>
        ...
        <section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none" style="color: white">User</h3>
                <small style="color: white">View Users</small>
              </div>
                                            ...
                                            <tbody>
                                              ...
                                              ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="statuschange.php?id=<?php echo $row['id']; ?>">Block User</a></td>
                                                </tr>
